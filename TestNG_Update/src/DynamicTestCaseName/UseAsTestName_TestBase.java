	  ...
	  if (useAsTestName != null) {
	   ...
	   if (useAsTestName.idx() > parameters.length - 1) {
	    throw new IllegalArgumentException(
	      String.format("We have been asked to use an incorrect parameter as a Test Case ID. The {0} annotation on method {1} is asking us to use the parameter at index {2} in the array and there are only {3} parameters in the array.",
	   ...
	   if (!String.class.isAssignableFrom(parmAsObj.getClass())) {
	    throw new IllegalArgumentException(
	      String.format("We have been asked to use a parameter of an incorrect type as a Test Case Name. The {0} annotation on method {1} is asking us to use the parameter at index {2} in the array that parameter is not usable as a string. It is of type {3}",
	        UseAsTestName.class.getSimpleName(),
	        method.getName(), useAsTestName.idx(),
